...
ds = CocoDatasetHandler('test_0/_annotations.coco.json', 'test_0/')
ds.coco2labelme()

print(ds.annotations)

# print(ds.labelme['758_png.rf.8ac77a82b5d3563876e20e343c00e64e.jpg'])
ds.save_labelme(ds.labelme.keys(), 'labelme/test_0')